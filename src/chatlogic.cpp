...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    //std::unique_ptr<GraphNode> rootNode = std::make_unique<GraphNode>(nullptr);
    ...
    ChatBot localChatBot("../images/chatbot.png"); // Create a local Chatbox instance on the stack
